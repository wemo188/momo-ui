...
var chatSet = '<div class="hp-upload" id="olSbScene"><svg viewBox="0 0 24 24"><path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"/><path d="M18.5 2.5a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5z"/></svg>编辑场景/时间线</div><div class="ol-sw-row" style="margin-bottom:12px;">人称称呼 '+sw('olPovOn',ap.povOn)+'</div><div id="olPovSub" style="'+(ap.povOn?'':'display:none;')+'"><div class="hp-slider-row" style="margin-bottom:18px;"><span class="hp-slider-label" style="width:60px">称呼用户</span><div style="display:flex;gap:12px;flex:1;"><button class="hp-btn ol-povu-btn" data-pov="first">第一人称</button><button class="hp-btn ol-povu-btn" data-pov="second">第二人称</button><button class="hp-btn ol-povu-btn" data-pov="third">第三人称</button></div></div><div class="hp-slider-row" style="margin-bottom:18px;"><span class="hp-slider-label" style="width:60px">称呼角色</span><div style="display:flex;gap:12px;flex:1;"><button class="hp-btn ol-povc-btn" data-pov="first">第一人称</button><button class="hp-btn ol-povc-btn" data-pov="second">第二人称</button><button class="hp-btn ol-povc-btn" data-pov="third">第三人称</button></div></div></div><div class="hp-slider-row" style="margin-bottom:18px;"><span class="hp-slider-label" style="width:60px">期望字数</span><input type="number" id="olWordCount" placeholder="留空不限" value="'+(ap.wordCount||'')+'" style="flex:1;min-width:0;height:42px;padding:0 12px;box-sizing:border-box;border:1.5px solid #adcdea;border-radius:8px;font-size:14px;box-shadow:0 1px 4px rgba(0,0,0,0.05);outline:none;"></div>';

var appSet = '<div class="ol-sub-title">整体</div><div class="ol-color-grid" style="grid-template-columns:repeat(2,1fr);margin-bottom:12px;"><div class="ol-color-item"><div class="hp-color-dot" id="olPageBg"></div><span>页面背景</span></div></div><div class="hp-upload" id="olSbBg"><svg viewBox="0 0 24 24"><rect x="3" y="3" width="18" height="18" rx="2" ry="2"/><circle cx="8.5" cy="8.5" r="1.5"/><polyline points="21 15 16 10 5 21"/></svg>上传背景</div><div class="hp-slider-row"><span class="hp-slider-label">白色遮罩</span><input type="range" id="olBgBlur" min="0" max="100" value="'+ap.bgBlur+'"><span class="hp-slider-val" id="olBgBlurVal">'+ap.bgBlur+'%</span></div><div class="hp-slider-row"><span class="hp-slider-label">明度视觉</span><input type="range" id="olBgDark" min="0" max="80" value="'+ap.bgDark+'"><span class="hp-slider-val" id="olBgDarkVal">'+ap.bgDark+'%</span></div><div class="hp-slider-row" style="margin-bottom:18px;"><span class="hp-slider-label" style="width:60px">字体选择</span><select id="olChatFont" class="ol-select-arrow" style="width:110px;height:42px;padding:0 30px 0 12px;box-sizing:border-box;border:1px solid #eee;border-radius:8px;font-size:14px;color:#1a1a1a;background-color:#fff;outline:none;font-family:inherit;-webkit-appearance:none;appearance:none;box-shadow:0 1px 4px rgba(0,0,0,0.05);"></select></div><div class="hp-btn-row"><button class="hp-btn ol-mode-btn" data-mode="bubble">气泡模式</button><button class="hp-btn ol-mode-btn" data-mode="parallel">全屏沉浸</button></div><div class="hp-divider"></div><div class="ol-sub-title">顶部区域</div><div class="ol-color-grid" style="grid-template-columns:repeat(2,1fr);margin-bottom:12px;"><div class="ol-color-item"><div class="hp-color-dot" id="olCardBg"></div><span>卡片背景</span></div><div class="ol-color-item"><div class="hp-color-dot" id="olCardTextColor"></div><span>卡片文字</span></div></div><div style="display:flex;gap:8px;margin-bottom:12px;"><button class="hp-btn hp-btn-outline" id="olBtnUp1">传图1</button><button class="hp-btn hp-btn-outline" id="olBtnUp2">传图2</button><button class="hp-btn hp-btn-outline" id="olBtnUp3">传图3</button><button class="hp-btn hp-btn-outline" id="olBtnUp4">传图4</button></div><input type="file" id="olCardUpInput" accept="image/*" hidden><div style="display:flex;gap:8px;margin-bottom:8px;"><input type="text" id="olCardT1" style="border:1.5px solid #adcdea; flex:1; height:40px; border-radius:8px; padding:0 10px; outline:none;" placeholder="银河歌颂" value="'+App.escAttr(ap.cardT1)+'"><input type="text" id="olCardT2" style="border:1.5px solid #adcdea; flex:1; height:40px; border-radius:8px; padding:0 10px; outline:none;" placeholder="梦想在冒险" value="'+App.escAttr(ap.cardT2)+'"></div><div style="display:flex;gap:8px;margin-bottom:12px;"><input type="text" id="olCardT3" style="border:1.5px solid #adcdea; flex:1; height:40px; border-radius:8px; padding:0 10px; outline:none;" placeholder="星星怀抱月夜" value="'+App.escAttr(ap.cardT3)+'"><input type="text" id="olCardT4" style="border:1.5px solid #adcdea; flex:1; height:40px; border-radius:8px; padding:0 10px; outline:none;" placeholder="明天想见你" value="'+App.escAttr(ap.cardT4)+'"></div><div class="hp-slider-row" style="margin-bottom:12px;"><span class="hp-slider-label" style="width:60px">卡片字体</span><select id="olCardFont" class="ol-select-arrow" style="width:110px;height:42px;padding:0 30px 0 12px;box-sizing:border-box;border:1px solid #eee;border-radius:8px;font-size:14px;color:#1a1a1a;background-color:#fff;outline:none;font-family:inherit;-webkit-appearance:none;appearance:none;box-shadow:0 1px 4px rgba(0,0,0,0.05);"></select></div><div class="hp-btn-row"><button class="hp-btn hp-btn-danger" id="olCardReset">恢复顶部默认</button></div><div class="hp-divider"></div><div class="ol-sub-title">底部区域</div><div class="ol-color-grid" style="grid-template-columns:repeat(4,1fr);margin-bottom:12px;"><div class="ol-color-item"><div class="hp-color-dot" id="olBarBg"></div><span>底色</span></div><div class="ol-color-item"><div class="hp-color-dot" id="olBarBorderColor"></div><span>边框</span></div><div class="ol-color-item"><div class="hp-color-dot" id="olBarIconColor"></div><span>图标</span></div><div class="ol-color-item"><div class="hp-color-dot" id="olInputTextColor"></div><span>文字</span></div></div><div class="hp-slider-row" style="margin-bottom:12px;"><span class="hp-slider-label" style="width:60px">底栏粗细</span><input type="range" id="olBarBorderW" min="0" max="5" step="0.5" value="'+ap.barBorderW+'"><span class="hp-slider-val" id="olBarBorderWVal">'+ap.barBorderW+'px</span></div><div class="hp-slider-row" style="margin-bottom:12px;"><span class="hp-slider-label" style="width:60px">底栏圆角</span><input type="range" id="olBarRadius" min="0" max="30" value="'+ap.barRadius+'"><span class="hp-slider-val" id="olBarRadiusVal">'+ap.barRadius+'px</span></div><div class="hp-slider-row" style="margin-bottom:12px;"><span class="hp-slider-label" style="width:60px">装饰文字</span><input type="text" id="olPlaceholderInput" style="flex:1;height:42px;padding:0 12px;box-sizing:border-box;border:1.5px solid #adcdea;border-radius:8px;font-size:14px;color:#1a1a1a;background-color:#fff;outline:none;box-shadow:0 1px 4px rgba(0,0,0,0.05);" value="'+App.escAttr(ap.placeholder||'宇宙带着星轨在私奔✮ ࣪ ⊹⋆˚')+'"></div><div class="hp-btn-row"><button class="hp-btn hp-btn-outline" id="olSbBarBgBtn">底栏图填充</button><button class="hp-btn hp-btn-danger" id="olSbBarBgDel">清除底栏图</button></div><div class="hp-btn-row"><button class="hp-btn hp-btn-danger" id="olBarReset">恢复底部默认</button></div>';

var roleSet = cAv+cBub+cFont;
var userSet = uAv+uBub+uFont;
...
fold('olFChatSet', '聊天设置', chatSet) +
fold('olFAppSet', '外观', appSet) +
fold('olFRole', '角色板块', roleSet) +
fold('olFUser', '用户板块', userSet) +
'<div class="hp-btn-row"><button class="hp-btn hp-btn-outline" id="olThemeSave" style="padding:14px 0;">存储为新主题</button></div>' +
'<div class="hp-btn-row"><button class="hp-btn hp-btn-danger" id="olStyleReset" style="padding:14px 0;">恢复默认</button></div>' +
'<div class="hp-btn-row"><button class="hp-btn hp-btn-primary" id="olSbCode" style="padding:14px 0;">自定义UI</button></div>' +
...
App.safeOn('#olCardReset','click',function(){
  ...
  ap.cardT1='银河歌颂'; ap.cardT2='梦想在冒险'; ap.cardT3='星星怀抱月夜'; ap.cardT4='明天想见你';
  for(var i=1;i<=4;i++){
    App.LS.remove('ol_photo_'+cid+'_'+i);
    var ipt=App.$('#olCardT'+i); if(ipt) ipt.value=ap['cardT'+i];
    var card=App.$('.mm-ec-'+i);
    if(card){
      var img=card.querySelector('.mm-env-img');
      var pl=card.querySelector('.mm-env-placeholder');
      ...
      if(cap)cap.textContent=ap['cardT'+i];
    }
  }
...
App.safeOn('#olThemeSave','click',function(){App.showToast('主题已保存 (开发中)');});
App.safeOn('#olStyleReset','click',function(){App.LS.remove('olAp_'+cid);ap=JSON.parse(JSON.stringify(DEF_AP));sAp(cid,ap);O.applyAppearance(cid);O._noScroll=true;O.renderMessages();App.showToast('外观已恢复默认');});
