...
'<div class="mm-cards-wrapper" id="olCardsWrap">' +
  '<div class="mm-env-card mm-ec-1"><div class="mm-env-inner"><img class="mm-env-img" src="'+p1+'" style="display:'+(p1?'block':'none')+'"><div class="mm-env-placeholder" style="display:'+(p1?'none':'flex')+'"><svg viewBox="0 0 24 24" width="16" height="16" stroke="currentColor" stroke-width="2" fill="none"><rect x="3" y="3" width="18" height="18" rx="2"/><circle cx="8.5" cy="8.5" r="1.5"/><polyline points="21 15 16 10 5 21"/></svg></div></div><div class="mm-env-caption">'+App.esc(ap.cardT1)+'</div></div>' +
  '<div class="mm-env-card mm-ec-2"><div class="mm-env-inner"><img class="mm-env-img" src="'+p2+'" style="display:'+(p2?'block':'none')+'"><div class="mm-env-placeholder" style="display:'+(p2?'none':'flex')+'"><svg viewBox="0 0 24 24" width="16" height="16" stroke="currentColor" stroke-width="2" fill="none"><line x1="12" y1="5" x2="12" y2="19"/><line x1="5" y1="12" x2="19" y2="12"/></svg></div></div><div class="mm-env-caption">'+App.esc(ap.cardT2)+'</div></div>' +
  '<div class="mm-env-card mm-ec-3"><div class="mm-env-inner"><img class="mm-env-img" src="'+p3+'" style="display:'+(p3?'block':'none')+'"><div class="mm-env-placeholder" style="display:'+(p3?'none':'flex')+'"><svg viewBox="0 0 24 24" width="16" height="16" stroke="currentColor" stroke-width="2" fill="none"><path d="M20.84 4.61a5.5 5.5 0 0 0-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 0 0-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 0 0 0-7.78z"/></svg></div></div><div class="mm-env-caption">'+App.esc(ap.cardT3)+'</div></div>' +
  '<div class="mm-env-card mm-ec-4"><div class="mm-env-inner"><img class="mm-env-img" src="'+p4+'" style="display:'+(p4?'block':'none')+'"><div class="mm-env-placeholder" style="display:'+(p4?'none':'flex')+'"><svg viewBox="0 0 24 24" width="16" height="16" stroke="currentColor" stroke-width="2" fill="none"><polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2"/></svg></div></div><div class="mm-env-caption">'+App.esc(ap.cardT4)+'</div></div>' +
